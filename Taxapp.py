...
# 메인 화면
# ==========================================
# 1. 로고와 제목을 세련되게 나란히 배치 (HTML 컨테이너)
st.markdown("""
    <div style="display: flex; align-items: center; margin-bottom: 5px;">
        <img src="https://raonheritage.com/logo.jpg" width="40" style="margin-right: 12px;">
        <h1 style="margin: 0; color: #1e3a8a;">맞춤형 상속/증여 컨설팅 AI</h1>
    </div>
""", unsafe_allow_html=True)

# 2. 사라졌던 안내 문구를 깔끔한 캡션 스타일로 복구
st.markdown("<p style='color: #475569; font-size: 16px; margin-bottom: 30px;'>사이드바에 고객님의 상황을 입력한 뒤 질문하시면, 라온헤리티지연구소의 축적된 판례를 바탕으로 최적의 솔루션을 제공합니다.</p>", unsafe_allow_html=True)
