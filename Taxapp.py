...
# 1. 대표님이 가져오신 Base64 이미지 데이터를 변수에 저장합니다.
# (따옴표 안에 데이터를 그대로 복사해서 넣으시면 됩니다.)
custom_icon = "data:image/jpeg;base64,/9j/2wBDAAYEBQYFBAYGBQYHBwYIChAKCgkJChQODwwQFxQYGBcUFhYaHSUfGhsjHBYWICwgIyYnKSopGR8tMC0oMCUoKSj/..."

# 2. page_icon 부분에 이모지 대신 custom_icon 변수를 넣습니다.
st.set_page_config(page_title="라온헤리티지연구소 세무 AI", page_icon=custom_icon, layout="wide")
